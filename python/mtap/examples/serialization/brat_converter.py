...
from mtap import serialization
from mtap.serialization import brat
...
def main(args=None):
    ...
    parser.add_argument('--serializer', type=serialization.get_serializer,
                        choices=list(serialization.standard_serializers.keys()), default='json')
