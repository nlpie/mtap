...
func request_Pipeline_Process_0(ctx context.Context, marshaler runtime.Marshaler, client PipelineClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ProcessEventInPipelineRequest
...
func local_request_Pipeline_Process_0(ctx context.Context, marshaler runtime.Marshaler, server PipelineServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ProcessEventInPipelineRequest
	var metadata runtime.ServerMetadata
...
func RegisterPipelineHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PipelineServer) error {
	...
	mux.Handle("POST", pattern_Pipeline_Process_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mtap.api.v1.Pipeline/Process", runtime.WithHTTPPathPattern("/v1/pipeline/{pipeline_id}/process"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Pipeline_Process_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Pipeline_Process_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPipelineHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PipelineClient) error {
	...
	mux.Handle("POST", pattern_Pipeline_Process_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mtap.api.v1.Pipeline/Process", runtime.WithHTTPPathPattern("/v1/pipeline/{pipeline_id}/process"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Pipeline_Process_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Pipeline_Process_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"v1", "pipeline", "pipeline_id", "process"}, ""))
)

var (
	forward_Pipeline_Process_0 = runtime.ForwardResponseMessage
)
