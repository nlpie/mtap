...
public class StandardLabelIndexDescendingViewTest {
  ...
  @Test
  void beginsInside() {
    LabelIndex<Span> beginsInside = descending.beginsInside(Span.of(1, 10));
    assertEquals(Arrays.asList(
        Span.of(9, 13),
        Span.of(9, 13),
        Span.of(9, 10),
  ...
  void beginsInsideEmpty() {
    LabelIndex<Span> beginsInside = descending.beginsInside(3, 5);
  ...
  void emptyAscendingBegin() {
    ...
    assertEquals(Collections.emptyList(), ascendingStartIndex.asList());
  }

  @Test
  void descendingBegin() {
    LabelIndex<Span> descendingStartIndex = descending.descendingStartIndex();
    assertSame(descending, descendingStartIndex);
  }
  ...
  @Test
  void ascendingEnd() {
    LabelIndex<Span> ascendingEndIndex = descending.ascendingEndIndex();
    assertEquals(Arrays.asList(
        Span.of(9, 10),
        Span.of(9, 13),
        Span.of(9, 13),
