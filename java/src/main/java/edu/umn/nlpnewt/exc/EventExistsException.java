 ...
 */
public class EventExistsException extends NewtException {
  ...
  public EventExistsException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
