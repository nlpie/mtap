...
public class NewtInternalProcessing extends ProcessorServerOptions {
  ...
  private Supplier<JsonObjectBuilder<?, ?>> jsonObjectBuilderSupplier = null;
  private ProcessingResultFactory processingResultFactory = null;
  ...
  public NewtEvents getEvents() {
    if (events == null) {
      events = NewtInternalEvents.createEvents(config, getEventsTarget());
    }
    return events;
  }
  ...
  public ProcessorRunner getProcessorRunner() {
    if (processorRunner == null) {
      ...
      processorRunner = new ProcessorRunnerImpl(
          ...
          getProcessorName(),
          getIdentifier(),
          getJsonObjectBuilderSupplier(),
          getProcessingResultFactory()
      );
    }
  ...
  public Supplier<JsonObjectBuilder<?, ?>> getJsonObjectBuilderSupplier() {
    if (jsonObjectBuilderSupplier == null) {
      return JsonObjectImpl::newBuilder;
    }
    return jsonObjectBuilderSupplier;
  }

  public void setJsonObjectBuilderSupplier(Supplier<JsonObjectBuilder<?, ?>> jsonObjectBuilderSupplier) {
  ...
  public ProcessingResultFactory getProcessingResultFactory() {
    if (processingResultFactory == null) {
      processingResultFactory = ProcessingResultImpl::new;
    }
    return processingResultFactory;
  }

  public void setProcessingResultFactory(ProcessingResultFactory processingResultFactory) {
